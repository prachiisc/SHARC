...
class GraphConvLayer(nn.Module):
    ...
    def forward(self, bipartite, feat):
        ...
        graph.update_all(fn.u_mul_e('h', 'affine', 'm'), # elementwise multiplication of feats and affinity all the neighbors of dstdat
                         fn.sum(msg='m', out='h')) # sum all the elements to generate one neighbour feature 
